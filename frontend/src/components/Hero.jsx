    ...
    <div className='px-4 md:px-0 h-[720px] '>
        <div className='max-w-7xl mx-auto flex flex-col md:flex-row items-center h-[600px] my-10 md:my-0'>
            ...
            <div className='max-w-2xl'>
                <h1 className='text-4xl md:text-6xl font-bold mb-4'>Lorem ipsum dolor sit amet consectetur.</h1>
                <p className='text-lg md:text-xl opacity-80 mb-6'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Tenetur odit fugit voluptas corrupti rerum!</p>
