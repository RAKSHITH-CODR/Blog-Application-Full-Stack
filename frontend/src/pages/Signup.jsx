...
import { Eye, EyeOff, Loader2, Tractor } from 'lucide-react'
...
const Signup = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axios.post(`https://blog-application-full-stack.onrender.com/api/v1/user/register`, user, {
        headers: {
  ...
  return (
    <div className='flex h-screen md:pt-14 md:h-[945px]'>
      <div className='hidden md:block'>
        <img src={auth} alt="" className='h-[889px]'/>
      </div>
          ...
          <CardContent>
            <form className='space-y-4' onSubmit={handleSubmit}>
              ...
              <div className='relative'>
                ...
                onChange ={handleChange}
                />
                <button onClick={() => setShowPassword(!showPassword)} type='button' className='cursor-pointer absolute right-3 top-6 text-gray-500'>
